...
#
# pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:44
class Tapioca::Dsl::Compilers::ActiveRecordFixtures < ::Tapioca::Dsl::Compiler
  ...
  # @override
  #
  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:53
  sig { override.void }
  def decorate; end

  private

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:119
  sig { params(mod: ::RBI::Scope, name: ::String).void }
  def create_fixture_method(mod, name); end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:165
  sig { returns(T::Hash[::String, ::String]) }
  def fixture_class_from_active_record_base_class_mapping; end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:151
  sig { params(fixture_name: ::String).returns(T.nilable(::String)) }
  def fixture_class_from_fixture_set(fixture_name); end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:180
  sig { returns(T::Hash[::String, ::String]) }
  def fixture_class_mapping_from_fixture_files; end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:84
  def fixture_loader(*args, **, &blk); end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:109
  sig { returns(T::Array[::String]) }
  def method_names_from_eager_fixture_loader; end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:104
  sig { returns(T::Array[::String]) }
  def method_names_from_lazy_fixture_loader; end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:143
  ...
  class << self
    # @override
    #
    # pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:74
    sig { override.returns(T::Enumerable[T::Module[T.anything]]) }
    def gather_constants; end
  end
end

# pkg:gem/tapioca#lib/tapioca/dsl/compilers/active_record_fixtures.rb:49
...
# ~~~
#
# pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:184
class Tapioca::Dsl::Compilers::UrlHelpers < ::Tapioca::Dsl::Compiler
  ...
  # @override
  #
  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:191
  sig { override.void }
  def decorate; end

  private

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:476
  sig { params(mod: ::RBI::Scope, helper_module: T::Module[T.anything]).void }
  def create_engine_helper_mixin(mod, helper_module); end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:464
  sig { params(mod: ::RBI::Scope).void }
  def create_engine_helper_mixins(mod); end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:489
  sig { params(mod: ::RBI::Scope, helper_module: T::Module[T.anything]).void }
  def create_mixins_for(mod, helper_module); end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:427
  sig { params(mod: T::Module[T.anything]).returns(T::Boolean) }
  def engine_helper_module?(mod); end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:363
  sig { params(root: ::RBI::Tree, constant: T::Module[T.anything]).void }
  def generate_module_for(root, constant); end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:379
  sig { params(root: ::RBI::Tree).void }
  def generate_mounted_helpers_module(root); end

  # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:439
  sig { void }
  def generate_url_helper_includer; end

  class << self
    # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:213
    sig { returns(T::Hash[::Symbol, T.class_of(Rails::Engine)]) }
    def engine_mount_names; end

    # @override
    #
    # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:217
    sig { override.returns(T::Enumerable[T::Module[T.anything]]) }
    def gather_constants; end

    private

    # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:280
    ...
    #
    # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:344
    ...
    #
    # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:297
    sig { returns(T::Hash[::Symbol, T.class_of(Rails::Engine)]) }
    def mounted_engine_names; end
    ...
    #
    # pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:312
    sig { returns(T::Array[T::Module[T.anything]]) }
    def register_engine_route_helpers; end
  end
end

# pkg:gem/tapioca#lib/tapioca/dsl/compilers/url_helpers.rb:358
...
module Tapioca::Dsl::Helpers::GraphqlTypeHelper
  ...
  # pkg:gem/tapioca#lib/tapioca/dsl/helpers/graphql_type_helper.rb:106
  sig { params(constant: T::Module[T.anything]).returns(::String) }
  def type_for_constant(constant); end

  # pkg:gem/tapioca#lib/tapioca/dsl/helpers/graphql_type_helper.rb:124
